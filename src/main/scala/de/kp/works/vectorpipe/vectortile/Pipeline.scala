...
import de.kp.works.vectorpipe.vectortile.export._
...
/**
  ...
  * [[de.kp.works.vectorpipe.OSM#toGeometry OSM.toGeometry]] and any filtering/modification
  ...
  * The only extra note is that [[de.kp.works.vectorpipe.vectortile.Pipeline#reduce reduce]]
  * and [[de.kp.works.vectorpipe.vectortile.Pipeline#simplify simplify]] will be called prior
...
trait Pipeline {
  ...
  /**
    ...
    * possible by the [[de.kp.works.vectorpipe.vectortile.Pipeline#reduce reduce]] function.
    *
  ...
  /**
    ...
    * [[de.kp.works.vectorpipe.vectortile.Simplify]].
    */
  ...
  /**
    ...
    *
    * If [[de.kp.works.vectorpipe.vectortile.Pipeline#layerMultiplicity layerMultiplicity]]
    * is true, the resulting DataFrame must supply a String-typed column of the name
    * contained in [[de.kp.works.vectorpipe.vectortile.Pipeline#geometryColumn geometryColumn]]
  ...
  /**
    ...
    * [[de.kp.works.vectorpipe.vectortile.Clipping Clipping]].
    */
...
object Pipeline {
  ...
  /**
    ...
    * [[de.kp.works.vectorpipe.vectortile.Pipeline.Output#finalize finalize]]
    * saving to either S3 or Hadoop based on the user-defined
    * [[de.kp.works.vectorpipe.vectortile.Pipeline.Output#baseOutputURI baseOutputURI]]
    * <p>
  ...
  trait Output {
    ...
    /**
      * Receive the final RDD of generated vector tiles for a zoom level
      * to finish any additional processing or handling such as persisting to a datastore.
      * @see [[de.kp.works.vectorpipe.vectortile.Pipeline.Output Pipeline.Output]]
      */
